...
But du script :
    ...
    pour peupler les tables du schéma 'silver' à partir du schéma 'bronze'.
	Actions effectuées :
		- Tronque les tables du schéma Silver.
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT
            ...
            SUBSTRING(prd_key, 7, LEN(prd_key) - 5) AS prd_key,
            prd_nm,
        ...
        SELECT
            ...
            CASE
                ...
                WHEN sls_sales <> sls_quantity * ABS(sls_price) THEN ABS(sls_price) * sls_quantity
            ELSE sls_sales
        END AS sls_sales,
            sls_quantity,
            CASE
        ...
        SELECT
            CASE
                WHEN cid LIKE 'NAS%' THEN SUBSTRING(cid, LEN('NAS') + 1, LEN(cid) - LEN('NAS'))
                ELSE cid
            END AS cid,
            CASE
